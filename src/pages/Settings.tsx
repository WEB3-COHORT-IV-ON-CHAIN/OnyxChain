    ...
    <div className="min-h-full bg-black flex flex-col p-6 overflow-y-auto">
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 text-blue-400 transition-transform ${showSeedPhrase ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
